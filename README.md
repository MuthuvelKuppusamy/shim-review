...
-------------------------------------------------------------------------------
Yes, used the source tar from  https://github.com/rhboot/shim/releases/download/15.6/shim-15.6.tar.bz2
and added our custom patch to precedence for ProxyOfferReceived in IPV4/6
...
We switched to new certificate now for shim15.6 signing, which blocks all the older signed grub2 binaries.
...
-------------------------------------------------------------------------------
We switched to new certificate now for shim15.6 signing.
...
-------------------------------------------------------------------------------
No changes added. Only the version update from shim 15.4 to 15.6.
...
shim.MFZENworks,1,MicroFocus,shim,15.6-0-ZENworks1,https://www.microfocus.com/
